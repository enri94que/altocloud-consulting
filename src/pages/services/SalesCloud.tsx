  ...
  return (
    <Layout>
      <SEO
        ...
        description={language === "es" ? "Sales Cloud: gestión de leads, automatización comercial y previsiones de ventas. Consultor Salesforce certificado para impulsar tus ventas." : "Sales Cloud: lead management, sales automation and forecasting. Certified Salesforce consultant to boost your sales."}
