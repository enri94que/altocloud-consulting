...
const services = [
  { value: "Sales_Cloud", label: "Sales_Cloud" },
  { value: "Service_Cloud", label: "Service_Cloud" },
  { value: "Nonprofit_Cloud", label: "Nonprofit_Cloud" },
  { value: "Starter_and_Pro_Suite", label: "Starter_and_Pro_Suite" },
