...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    // Hero Section
    "hero.badge": "Consultor Certificado en Salesforce",
    "hero.title": "Transforma tu empresa con el poder de",
    "hero.description": "Consultor de Salesforce en España especializado en implementación CRM profesional. Impulsa tus ventas, mejora tu atención al cliente y optimiza tus procesos con automatización de ventas con Salesforce.",
    "hero.cta": "Contactar",
    "hero.intro": "Soy",
    "hero.name": "Enrique",
    "hero.subtitle": "experto en soluciones empresariales con Salesforce",
    ...
    "services.title": "Soluciones con Salesforce a tu medida",
    "services.implementation.title": "Implementación de Salesforce",
    "services.implementation.description": "Implantación completa en 5 fases, desde el discovery hasta el go live, con soluciones como Sales Cloud, Service Cloud o Starter & Pro Suite.",
    "services.implementation.link": "Ver implementación",
    "services.optimization.title": "Optimización y Ajustes",
    "services.optimization.description": "Auditoría y mejora de tu configuración actual de Salesforce para sacar el máximo partido a clouds como Sales Cloud o Service Cloud.",
    "services.optimization.link": "Ver optimización",
    "services.administration.title": "Administración y Soporte",
    "services.administration.description": "Tu System Admin externo: mantenimiento y soporte continuo de tus clouds de Salesforce sin contratar un recurso a tiempo completo.",
    "services.administration.link": "Ver administración",
    "services.consulting.title": "Consultoría Estratégica",
    "services.consulting.description": "Asesoramiento experto para definir tu estrategia CRM y elegir la solución adecuada: Sales Cloud, Service Cloud, Nonprofit Cloud o Starter & Pro Suite.",
    "services.consulting.link": "Ver consultoría",

    // Why Salesforce
    "why.label": "¿Por qué Salesforce?",
    "why.title": "El CRM #1 del mundo por una razón",
    "why.description": "Salesforce no es solo un CRM, es la plataforma líder en automatización de ventas con Salesforce y gestión de clientes empresarial. Con más de 150.000 empresas confiando en Salesforce, es la elección preferida para la transformación digital España. Como consultor de Salesforce en España, te ayudo con la implementación CRM profesional que tu negocio necesita.",
    ...
    "contactStrip.description": "Agenda una consulta gratuita sobre Salesforce y descubre cómo la implementación CRM profesional puede impulsar tu empresa.",
    ...
    // Footer
    "footer.description": "Consultores especializados en soluciones con Salesforce. Ayudamos a empresas a transformar sus procesos de negocio con las mejores soluciones CRM del mercado.",
    ...
    // Pricing Page
    "pricing.badge": "Precios oficiales de Salesforce 2025",
  ...
  en: {
    ...
    "services.implementation.description": "Complete 5-phase implementation, from discovery to go live, with solutions such as Sales Cloud, Service Cloud or Starter & Pro Suite.",
    "services.implementation.link": "See implementation",
    "services.optimization.title": "Optimization & Adjustments",
    "services.optimization.description": "Audit and improvement of your current Salesforce setup to get the most out of clouds like Sales Cloud or Service Cloud.",
    "services.optimization.link": "See optimization",
    "services.administration.title": "Administration & Support",
    "services.administration.description": "Your external System Admin: continuous maintenance and support of your Salesforce clouds without hiring a full-time resource.",
    "services.administration.link": "See administration",
    "services.consulting.title": "Strategic Consulting",
    "services.consulting.description": "Expert advisory to define your CRM strategy and choose the right solution: Sales Cloud, Service Cloud, Nonprofit Cloud or Starter & Pro Suite.",
    "services.consulting.link": "See consulting",
