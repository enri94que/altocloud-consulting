...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "hero.cta": "Contactar",
    "hero.intro": "Experto en soluciones empresariales con Salesforce",
    ...
    "services.implementation.description": "Pongo Salesforce en marcha en tu empresa con una metodología ágil en 5 fases: del discovery al go live, te acompaño en cada paso.",
    "services.implementation.link": "Ver implementación",
    "services.optimization.title": "Optimización y Ajustes",
    "services.optimization.description": "Audito y ajusto tu configuración actual para que recuperes el rendimiento que esperabas de Salesforce.",
    "services.optimization.link": "Ver optimización",
    "services.administration.title": "Administración y Soporte",
    "services.administration.description": "Actúo como tu System Admin externo: mantenimiento, soporte y gestión diaria sin contratar a nadie a tiempo completo.",
    "services.administration.link": "Ver administración",
    "services.consulting.title": "Consultoría Estratégica",
    "services.consulting.description": "Te asesoro para definir tu estrategia CRM y, si lo necesitas, elegir entre soluciones como Sales Cloud, Service Cloud, Nonprofit Cloud o Starter & Pro Suite.",
  ...
  en: {
    ...
    "hero.cta": "Contact",
    "hero.intro": "Expert in enterprise solutions with Salesforce",
    ...
    "services.implementation.description": "I get Salesforce up and running in your company with an agile 5-phase methodology: from discovery to go live, I'm with you every step.",
    "services.implementation.link": "See implementation",
    "services.optimization.title": "Optimization & Adjustments",
    "services.optimization.description": "I audit and fine-tune your current setup so you get back the performance you expected from Salesforce.",
    "services.optimization.link": "See optimization",
    "services.administration.title": "Administration & Support",
    "services.administration.description": "I act as your external System Admin: maintenance, support and day-to-day management without hiring anyone full-time.",
    "services.administration.link": "See administration",
    "services.consulting.title": "Strategic Consulting",
    "services.consulting.description": "I advise you on defining your CRM strategy and, if needed, choosing among solutions like Sales Cloud, Service Cloud, Nonprofit Cloud or Starter & Pro Suite.",
